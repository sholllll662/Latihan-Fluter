                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="target_hari" name="target_hari" autofocus placeholder="Name">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="target_total" class="col-sm-3 col-form-label">Target Total</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="target_total" name="target_total" placeholder="Target Total">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="target_s1" name="target_s1" placeholder="Target Shift 1">
                            </div>
                        </div>
                    </div>
